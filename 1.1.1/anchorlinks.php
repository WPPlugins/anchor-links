...
function GenerateSommaire($content){
	...
	$sommaire .= '</ul>';
		$i = 0;
	if($lien_top == 1){
		$retour_sommaire ="<a href=\"#sommaire\" title=\"Retour au sommaire\" rel=\"nofollow\"><img src=\"".get_bloginfo('wpurl')."/wp-content/plugins/anchor-links/sommaire.gif\" alt=\"Retour au sommaire\" /></a> ";
	}else{
		$retour_sommaire ="";
	}
